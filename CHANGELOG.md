...
- **Choose the kiosk's language under Device > User Interface.** Language is the first row in the group and offers English and Español, with English selected by default. Changes apply immediately on the kiosk and in remote administration and remain local to each kiosk. All 180 approved Spanish catalog messages are bundled, including Settings navigation, search and drawer actions. Screens outside the catalog remain in English.
