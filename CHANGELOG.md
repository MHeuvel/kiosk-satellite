...
### Added
- **Set brightness through an ESPHome action.** The new `set_brightness` action accepts a brightness percentage from 0 to 100, including 0% for devices that can turn off their backlight. It updates Default brightness and requires adaptive brightness to be off (#670).
