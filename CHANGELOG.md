...
### Added
- **Screen & Audio now has translation templates in both interfaces.** Screen, adaptive brightness, volume, audio device and microphone controls share 93 new catalog messages. Translated choices preserve hardware selectors and saved values.
