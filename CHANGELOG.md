...
### Added
- **Home Assistant Setup now has translation templates in both interfaces.** Connection validation, proxy guidance, dashboard selection and the User Interface, Theme, rotation, return-to-home, Hold mode and Optimizations subpages use the catalog. The Spanish translations are author-approved and use "panel de control" for dashboard. Dashboard names, entity names and stored paths remain unchanged.
