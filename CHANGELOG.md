...
### Added
- **Device settings now have translation templates in both interfaces.** The catalog covers User Interface, remote administration, configuration import/export, permissions, service status, updates, Shizuku, the optional update helper and analytics. All 489 catalog messages have author-approved Spanish translations. Translated option labels keep their original saved values.
