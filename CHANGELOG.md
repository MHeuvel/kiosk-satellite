...
### Added
- **Camera settings now use translation templates in both interfaces.** Six templates add 127 messages for camera controls, motion sensing, RTSP and ONVIF streaming, permissions, connected clients and remote snapshots. Translated controls preserve camera selections, addresses and stream settings.
