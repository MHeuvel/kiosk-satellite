...
### Changed
- **Clearer weather temperatures and larger widget details.** The Weather widget and Weather Mood bar show the apparent temperature on a separate localized Feels like line. Feels like only labels the apparent reading beneath its value. Weather widget conditions, readings and icons are larger relative to the temperature and the Clock widget date is larger.
