...
### Added
- **Screensaver media settings now use translation templates in both interfaces.** Home Assistant Media, Local Media, Photo Gallery, Immich and Camera Streams share 205 new catalog messages. Media pickers, connection results, filters, calendars and ordering controls preserve external names and saved values.
