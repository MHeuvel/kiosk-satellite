...
### Added
- **Screensaver Widgets and At a Glance now use translation templates in both interfaces.** Six templates add 106 messages for appearance, weather, entity search and editing. Translated editors preserve corner values, font choices, entity IDs and custom names. Saving a custom name also waits for the dialog to close before disposing its text controller.
