...
### Added
- **DLNA Renderer settings and playback notices use translation templates.** Fifteen messages cover receiver controls, shared port validation, playback errors and accessibility labels. Language changes preserve media titles and playback state.
