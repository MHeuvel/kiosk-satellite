...
### Added
- **Fleet Management and Plugin Manager use translation templates in both interfaces.** Twelve templates add 222 messages for profiles, invitations, fleet updates, plugin installation, actions and outputs. Language changes preserve profile IDs, plugin data and unsaved fields.
