...
### Added
- **Setup permissions and restore flows use translation templates.** Add 34 messages for service permissions, final permission guidance, backup validation, import progress and initial password errors. Status refreshes and the remote import waiting screen use the selected language while preserving grant requests and import options.
