...
### Added
- **Screensaver controls, Clock settings and schedules now use the translation catalog.** Both interfaces share 174 new messages for the main controls, Dim, Black and Website modes, Clock appearance, schedule overrides and shared time and color pickers. Translated editors preserve plugin names and stored values.
