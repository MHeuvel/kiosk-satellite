...
- **Choose the kiosk's language under Device > User Interface.** Language is the first row in the group and offers English and Español, with English selected by default. Changes apply immediately on the kiosk and in remote administration and remain local to each kiosk. The approved Spanish setup and shared settings translations are now bundled. Other messages fall back to English.
