...
### Added
- **Logs and About use translation templates in both interfaces.** Five templates add 43 messages for log controls, console notices, app details and update actions. Language changes preserve diagnostic output, typed JavaScript, filters and active downloads. About details fit narrow screens.
