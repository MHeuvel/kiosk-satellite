...
### Added
- **Live camera views use the selected language.** Connecting, playback failures and retry notices share 15 translation messages. Open views update their language without restarting streams and preserve camera names and protocol details.
