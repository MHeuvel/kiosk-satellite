...
### Added
- **Camera Streams settings now use translation templates in both interfaces.** Six templates add 112 messages for imports, Go2RTC servers, camera editors, views, playback and errors. Remote administration preserves the selected language during camera refreshes and keeps playback controls current.
