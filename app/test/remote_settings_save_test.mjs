...
import { deviceText, haText, screensaverError } from '../remote-ui/static/localization.js';
...
function client(key = 'browser.inject_js', { tag = 'textarea', type = 'textarea', value = 'old code', settingType = 'string' } = {}) {
  ...
  const context = vm.createContext({
    deviceText, haText, screensaverError, s: cached, state: { settings: [cached] }, row, Event,
